export const TOURS = {
  home: [
    {
      target: '[data-profile]',
      title: '👤 Set your username first',
      body: "Tap your profile picture → Edit Profile → set a username. This is how friends find you on PantryPal. Everything social — adding friends, sharing recipes, inviting people to your household — starts here."
    },
    {
      target: '#tour-home-shortcuts',
      title: '⚡ Quick shortcuts',
      body: 'Jump straight to the most used features — scan a receipt, view your shopping cart, or get recipe suggestions — all with one tap.'
    },
    {
      target: '#tour-home-pantry',
      title: '🧺 Your pantry at a glance',
      body: 'This card shows how many items are in stock, running low, and out of stock. Tap it anytime to go straight to your full pantry.'
    },
    {
      target: '#tour-home-household',
      title: '🏠 Household',
      body: 'Create a household to share your pantry with family or roommates. Once created, all members see the same pantry, cart, and receipt history in real time.'
    },
    {
      target: '#tour-home-shared',
      title: '📬 Shared with you',
      body: 'When a PantryPal friend shares a recipe or their shopping cart with you, it appears here. Tap View to save a recipe or Add to cart to merge their list with yours.'
    },
    {
      target: '#tour-bottom-nav',
      title: '🗂 Navigation bar',
      body: 'The bar at the bottom is how you navigate the app. My Pantry, Cart, Scan, History, and Recipes — each tab has its own walkthrough you can replay anytime.'
    },
    {
      target: '#tour-header',
      title: '↩ Header bar',
      body: "Tap the PantryPal logo or title anytime to come back to this home page. The ⓘ button on the right starts a step-by-step walkthrough for whatever page you're on."
    }
  ],
  pantry: [
    {
